    ...
    'items' => array(
      array(
        ...
        'items' => array(
          ...
          array('label'=>'Buses', 'url'=>array('/buses/admin'), 'visible'=>Yii::app()->user->checkAccess('Master'), 'active'=>false),
          array('label'=>'Drivers', 'url'=>array('/drivers/admin'), 'visible'=>Yii::app()->user->checkAccess('Master'), 'active'=>false),
